...
class Solution(object):
    ...
    def _snail_sum(
        ...
        snail_copy_1 = deepcopy(snail_num_1)
        snail_copy_1.parent = snail_sum
        snail_copy_1.side = 0
        snail_sum.left = snail_copy_1
        snail_copy_2 = deepcopy(snail_num_2)
        snail_copy_2.parent = snail_sum
        snail_copy_2.side = 1
        snail_sum.right = snail_copy_2
    ...
    def solve(self):
        with open(self.filename) as f:
            ...
            for first_idx in range(len(snail_numbers)):
                first = snail_numbers[first_idx]

                for second_idx in range(len(snail_numbers)):
                    if first_idx == second_idx:
                        continue
                    second = snail_numbers[second_idx]
                    snail_sum = self._snail_sum(first, second)
